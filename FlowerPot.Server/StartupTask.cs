...
namespace FlowerPot.Server
{
    public sealed class StartupTask : IBackgroundTask
    {
        ...
        public void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            restRouteHandler.RegisterController<FlowerController>();
            ...
            try
            {
                ...
                PotConnection.Instance.MessageReceived += ReceiveAppCommand; ;
                PotConnection.Instance.Connection = serviceTrigger.AppServiceConnection;
            }
            catch (Exception ex)
            {
        ...
        private AppMessage ReceiveAppCommand(AppMessage command)
        {
        ...
        private void WebService_Canceled(IBackgroundTaskInstance sender, BackgroundTaskCancellationReason reason)
        {
            ...
            if (PotConnection.IsValid)
            {
                ...
                PotConnection.Instance.Dispose();
            }
